...
void main() {
    ...
    System.out.println(labelsCreator.getLabel(Labels.Align.CENTER, 0, 5, 5, '+', '-', '|', "1. START", "2. Settings", "3. Credits", "4. Quit"));
    System.out.println(labelsCreator.getLabel(Labels.Align.LEFT, 0, 2, 5, '+', '-', '|', "CHARACTERS", "1. Create", "2. Change", "3. Edit", "4. Delete", "5. Go back"));
    for (int i = 1; i < 180; i++) {
